...
public enum TipoInfPagComp {
    ...
    TipoInfPagComp(final String codigo, final String descricao) {
        this.codigo = codigo;
    ...
    public static TipoInfPagComp valueOfCodigo(final String codigo) {
        for (TipoInfPagComp tipoEmitente : TipoInfPagComp.values()) {
